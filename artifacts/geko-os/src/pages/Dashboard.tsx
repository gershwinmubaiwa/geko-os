...
export function Dashboard({ mannequinData, setMannequinData, onSelectItem, selectedItemId, highlightedBrands }: DashboardProps) {
  ...
  return (
    <div className="flex w-full h-full p-5 gap-4 overflow-hidden">
      ...
      {/* 3D Viewport */}
      <div className="w-[40%] relative rounded-xl flex-shrink-0 shadow-[0_0_40px_rgba(139,92,246,0.06)]">
        <div className="absolute top-3 left-3 z-10 px-3 py-1 bg-card/80 backdrop-blur border border-primary/30 rounded-md">
